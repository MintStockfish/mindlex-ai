        ...
        {user && (
          <>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#06b6d4]/10 to-[#3b82f6]/10 mb-6">
              ...
              <span className="text-sm">Добро пожаловать, {user?.name}!</span>
            </div>
          </>
        )}
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-12">
        ...
        >
          ...
          <CardHeader>
            ...
            <CardDescription>
              Получите детальный разбор любого слова или предложения с
              переводом, произношением, примерами и этимологией
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        >
          ...
          <CardHeader>
            ...
            <CardDescription>
              Создавайте модули карточек и изучайте слова эффективно. Добавляйте
              слова из переводчика одним кликом
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-wrap gap-2">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground pl-4">
              Получайте полный разбор каждого слова с примерами и контекстом
            </p>
          </div>
          <div className="space-y-2">
            <div className="flex items-center gap-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground pl-4">
              IPA транскрипция и аудио для правильного произношения
            </p>
          </div>
          <div className="space-y-2">
            <div className="flex items-center gap-2">
