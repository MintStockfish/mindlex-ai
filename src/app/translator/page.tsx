...
export default function Translator() {
  ...
  const [analysisType, setAnalysisType] = useState<"word" | "sentence" | null>(
    null
  );
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    setAnalysisType(wordCount === 1 ? "word" : "sentence");
    setIsLoading(false);
  };
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl py-8 sm:py-12">
      ...
      <div className="min-h-[400px]">
        ...
        {!isLoading && analysisType === "word" && (
          <WordAnalysis word={query} onAddToCards={handleAddToCards} />
        )}
        ...
        {!isLoading && !analysisType && (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-muted-foreground max-w-md">
              ...
              разбор с переводом, произношением и примерами использования
            </p>
          </div>
        )}
      </div>
