...
export const FeatureCard = ({
    ...
    return (
        <Card className="group cursor-pointer hover:shadow-xl hover:border-[#06b6d4]/50 transition-transform duration-300 hover:-translate-y-2 overflow-hidden relative">
            <div
                className={cn(
