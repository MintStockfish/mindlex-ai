    ...
    words: [
      ...
      },
      {
        ...
        detail: {
          ...
          partOfSpeech: "Adjective",
          ipa: "/kwɪk/",
          meaning: "Движущийся или способный двигаться с большой скоростью",
      ...
      },
      {
        ...
        detail: {
          ...
          partOfSpeech: "Adjective",
          ipa: "/braʊn/",
          meaning: "Цвет, получаемый смешением красного, жёлтого и чёрного",
      ...
      },
      {
        ...
        detail: {
          ...
          partOfSpeech: "Noun",
          ipa: "/fɒks/",
          meaning: "Хищное млекопитающее семейства псовых с пушистым хвостом",
      ...
      },
      {
        ...
        detail: {
          ...
          partOfSpeech: "Verb",
          ipa: "/dʒʌmp/",
          meaning: "Отталкиваться от поверхности, чтобы подняться в воздух",
        ...
        <CardContent className="p-6 sm:p-8 space-y-6">
            ...
            <div className="bg-muted/50 rounded-lg p-4">
              <p className="text-lg leading-relaxed flex flex-wrap gap-2">
                {sentenceData.words.map((wordData, index) => (
                  <button
                    key={index}
                    onClick={() => setSelectedWord(wordData.detail)}
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gradient-to-r from-[#06b6d4]/10 to-[#3b82f6]/10 rounded-lg p-4">
              <p className="text-lg">{sentenceData.translation}</p>
            </div>
          </div>
          ...
          {selectedWord && (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <h4 className="text-sm text-muted-foreground">Произношение</h4>
              ...
              <div className="space-y-2">
                <h4 className="text-sm text-muted-foreground">Значение</h4>
